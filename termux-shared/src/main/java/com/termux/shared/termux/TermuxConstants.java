 ...
 * - Organização GitHub: instituto-Rafael
 * - App: Termux RAFCODEΦ (com.termux.rafacodephi)
 * - Repositórios: termux-app-rafacodephi, proot-distro, termux-packages
 */
public final class TermuxConstants {

    // ------------------------------------------------------------
    // 1. Organização e URLs básicas
    // ------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    // 2. App principal e seus recursos
    // ------------------------------------------------------------
    @NonNull
    ...
    // ------------------------------------------------------------
    // 4. Repositórios adicionais (fornecidos nos links)
    // ------------------------------------------------------------
    @NonNull
    ...
    // ------------------------------------------------------------
    // 5. Diretórios internos do app (baseados no pacote)
    // ------------------------------------------------------------
    @NonNull
    ...
    // ------------------------------------------------------------
    // 6. Diretórios do prefixo (ambiente Unix)
    // ------------------------------------------------------------
    @NonNull
    ...
    @NonNull
    public static final String TERMUX_USR_DIR_PATH = TERMUX_PREFIX_DIR_PATH; // alias
    @NonNull
